...
def validate_code_quality(code: str, file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        results["valid"] = False
        results["issues"].append({"type": "syntax_error", "line": e.lineno, "message": str(e)})
        return results
...
def validate_file_path(file_path: str) -> bool:
    ...
    # Agent-generated changes must never alter automation or repository metadata.
    if normalized.startswith((".github/", ".git/", ".env")):
        return False
